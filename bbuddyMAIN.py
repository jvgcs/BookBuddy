...
▄██▄▄▄█▀   ▀█▄▄█▀  ▀█▄▄█▀ ▄██▄ ██▄  ▀█▄▄▄▀   ▀█▄▄▀█▄ ▀█▄▄▀██▄ ▀█▄▄▀██▄     ▀█        |  | K |  |   |_|__|  | S |__|   | | |    |  |___| |
        ...
        if menu_input == '1':
            ...
            print("\033[34m"''' ▄▀▀ ▄▀▄ █▀▄ ▀█▀ █ █▄ █ ▄▀    ██▄ ▄▀▄ ▄▀▄ █▄▀ ▄▀▀
 ▄██ ▀▄▀ █▀▄  █  █ █ ▀█ ▀▄█   █▄█ ▀▄▀ ▀▄▀ █ █ ▄██'''"\033[0m""\n")
            print("\033[1m"'What would you like to sort your books by?'"\033[22m")
...
▀█▄    ██  ██   ██ ██   ██ █▄   ██   ██    █    ▀█▄█   ██       █  
 ▀▀█▄▄▄▀█   ▀█▄▄█▀  ▀█▄▄█▀ ▀█▄▄▀██▄  ▀█▄▄▄▀      ▀█     ▀█▄▄▄▀  ▄  
                                              ▄▄ █             ▀█▀ 
                                               ▀▀                  
            ''')
        elif menu_input == 'gamajuice':
            print("\033[35m", "\033[1m", '''                                        __
                                        /.-
                                ______ //
                               /______'/|
                               [       ]|
                               ...
                               '-------'  ''')
            main_menu()
        elif menu_input == 'gamabean':
            print("\033[33m", '''                .-""""-.
                / -   -  \\
                |  .-. .- |
                |  \\o| |o (
                \\     ^    \\     "you found me, can you find my juice?" - gama bean
                 '.  )--'  /
                   '-...-'`''')
            main_menu()
            exit()
                          ...
                          |    ;.-----.__ _-');   /
                           '--./         `.`/  `"`
                              ...
                              | \\     /  //
                               \\ '---'  /'
                                `------' ''', "\033[0m", "\n",
                  "\033[91m" + '"Invalid Input, please enter a valid input"' + "\033[0m")
